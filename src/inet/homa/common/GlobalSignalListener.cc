...
#include "inet/homa/application/WorkloadSynthesizer.h"
...
GlobalSignalListener::handleMesgStatsObj(cObject* obj)
{
    ...
    emit(bytesOnWireSignal, (long)mesgSizeOnWire);
    ...
    if (mesgLatencySignals.find(mesgSizeBin) == mesgLatencySignals.end()) {
        ...
        getEnvir()->addResultRecorders(this, bytesOnWireSig, bytesOnWireStatsName,
            statisticTemplate);
        ...
        getEnvir()->addResultRecorders(this, latencySignal, latencyStatsName,
            statisticTemplate);
        ...
        statisticTemplate = getProperties()->get("statisticTemplate",
            "mesgStretch");
        getEnvir()->addResultRecorders(this, stretchSignal, stretchStatsName,
            statisticTemplate);
        ...
        getEnvir()->addResultRecorders(this, transportSchedDelaySignal,
            transportSchedDelayStatsName, statisticTemplate);
    }

    emit(mesgBytesOnWireSignals.at(mesgSizeBin), (long)mesgSizeOnWire);
    ...
    , sendBacklog()
{
    ...
    // HomaCC.
    omnetpp::getSimulation()->getSystemModule()->subscribe("stabilitySignal", this);
    ...
    : parentModule(parentMod)
{
    ...
    omnetpp::getSimulation()->getSystemModule()->subscribe("mesgStats", this);
}
...
/**
 * This listener receives signals of type HomaCC::activeSchedsSignal
 * which carries time
 */
    ...
    , numEmitterTransport(0)
{
    ...
    // HomaCC fires. This signal carries a pointer to an object of type
    // HomaCC::ReceiveScheduler::ActiveScheds.
    omnetpp::getSimulation()->getSystemModule()->subscribe("activeScheds", this);
 ...
 * \param srcSigName
 *      name of one of the HomaCC::lowerSelfWasteSignal or
 *      HomaCC::highrSelfWasteSignal that this listener receives.
 * \param destSigName
...
{
    omnetpp::getSimulation()->getSystemModule()->subscribe(srcSigName, this);
