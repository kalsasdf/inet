...
class HomaTransport : public cSimpleModule
{
  PUBLIC:
    HomaTransport();
    uint32_t getrandpathid(){return intrand(8);}
    ~HomaTransport();


    static uint64_t msgID;

    std::map<uint64_t, L3Address> rcv_MsgId_SrcAddr;
    ...
    class InboundMessage
    {
      PUBLIC:
        ...
        explicit InboundMessage(HomaPkt* rxPkt, ReceiveScheduler* rxScheduler,
            HomaConfigDepot* homaConfig, string pckNameAtSender);
        ~InboundMessage();
        ...
        class CompareBytesToGrant
        {
          PUBLIC:
            ...
            bool operator()(const InboundMessage* msg1,
                const InboundMessage* msg2) const
            {
    ...
    class SendController
    {
      ...
      typedef struct {
        ...
        std::map<L3Address,PaceInfo> destsPaceInfoMap;
      ...
      PUBLIC:
        ...
        class OutbndMsgSorter {
          PUBLIC:
            OutbndMsgSorter(){}
            bool operator() (OutboundMessage* msg1, OutboundMessage* msg2) const ;
        };
    ...
    class ReceiveScheduler
    {
      PUBLIC:
        ...
        class SenderState {
          PUBLIC:
            ...
            std::set<InboundMessage*, InboundMessage::CompareBytesToGrant> mesgsToGrant;
      ...
      PROTECTED:
        ...
        //std::unordered_map<uint64_t, SenderState*> ipSendersMap;
  ...
  PUBLIC:
    ...
    HomaPkt *convertPacket2HomaPkt(Packet *pck);

    void sendCongestionNotification(L3Address cnp_srcaddr, L3Address cnp_destaddr, uint32_t ecn);
    /**
  ...
  PUBLIC:
     ...
     static simsignal_t LeftMsgIDSignal;
     static simsignal_t LeftMsgSizeSignal;
     static simsignal_t LeftMsgQueueSignal;
     static simsignal_t LeftMsgTxPckSignal;
     static simsignal_t LeftMsgsMapSignal;
     static simsignal_t RcvSenderMapSizeSignal;
     static simsignal_t RcvMsgToGrantSignal;
    /**
