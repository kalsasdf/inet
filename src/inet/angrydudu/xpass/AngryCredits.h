...
#ifndef __INET_ANGRYCREDITS_H
#define __INET_ANGRYCREDITS_H
...
class AngryCredits : public cSimpleModule
{
  protected:
  ...
  protected:
    ...
    virtual double feedback_control(double nowrate,int sumlost,int sumcredits);
    virtual double AL1_control(double nowrate,int sumlost, int sumcredits);
...
#endif // ifndef __INET_ANGRYCREDITS_H
