...
#ifndef __INET_RANDOMMETER_H
#define __INET_RANDOMMETER_H
 ...
 */
class INET_API RandomMeter : public cSimpleModule
{
  protected:

    //cQueue credit_queue;

    std::map<int, cPacket *> credit_buffer;
