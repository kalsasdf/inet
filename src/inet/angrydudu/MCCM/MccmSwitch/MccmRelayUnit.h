...
#ifndef __INET_MCCMRELAYUNIT_H
#define __INET_MCCMRELAYUNIT_H
...
class INET_API MccmRelayUnit : public cSimpleModule, public ILifecycle
{
  protected:
    ...
    int linkspeed;
    int nextif;
    simtime_t empty_time;

    std::map<int,simtime_t> queue_fulltime;
  ...
  protected:
    ...
    virtual void find_nextif(int regularif);
};

} // namespace inet

#endif // ifndef __INET_MCCMRELAYUNIT_H
