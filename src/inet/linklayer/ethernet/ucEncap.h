...
#ifndef __INET_UCENCAP_H
#define __INET_UCENCAP_H
 ...
 */
class INET_API ucEncap : public Ieee8022Llc
{
  protected:
  ...
  protected:
    ...
    virtual void updateRate(simtime_t now);
