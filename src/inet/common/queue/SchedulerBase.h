...
class INET_API SchedulerBase : public cSimpleModule, public IPassiveQueue, public IPassiveQueueListener
{
  protected:
    ...
    bool in_suspending = false;
    //bool in_pausing = false;
  ...
  protected:
    ...
    virtual bool markEcn() = 0;
    virtual int sendSuspend() = 0;
    virtual int sendPause(int Qn) = 0;
    virtual bool PausingQi(int Qn,bool pause) = 0;
