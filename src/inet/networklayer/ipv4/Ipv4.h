...
class INET_API Ipv4 : public QueueBase, public NetfilterBase, public ILifecycle, public INetworkProtocol, public IProtocolRegistrationListener, public cListener
{
  public:
    ...
    std::map<int, bool> IfSuspendMap;

  protected:
    //Ipv4RoutingTable *rt = nullptr;// modified by Shan Huang
    IIpv4RoutingTable *rt = nullptr;
    IInterfaceTable *ift = nullptr;

    int MidwareInterface;
  ...
  protected:
    ...
    /**
     * Added by angrydudu, 12/06/2019
     */
    virtual void SendSuspendToMidware(Packet *packet);
    virtual void ProcessSuspend(Packet *packet);
    virtual void ProcessPause(Packet *packet);
    virtual void BroadcastPause(Packet *packet);
    virtual void RegistMidwareInterface(Packet *packet);
