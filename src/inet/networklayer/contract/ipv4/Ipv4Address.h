...
class INET_API Ipv4Address
{
  ...
  public:
    ...
    static const Ipv4Address ALL_ECMP_ROUTERS_MCAST;    ///< 224.0.0.7 All ECMP routers (DR Others)
    static const Ipv4Address ALL_ECMP_DESIGNATED_ROUTERS_MCAST;    ///< 224.0.0.8 All ECMP Designated Routers
