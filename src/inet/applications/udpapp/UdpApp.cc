...
bool UdpApp::handleNodeStart(IDoneCallback *doneCallback)
{
...
bool UdpApp::handleNodeShutdown(IDoneCallback *doneCallback)
{
    if (selfMsg)
        cancelEvent(selfMsg);
