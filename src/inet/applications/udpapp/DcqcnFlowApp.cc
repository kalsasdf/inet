...
#include "inet/applications/udpapp/DcqcnFlowApp.h"
...
Define_Module(DcqcnFlowApp);

int DcqcnFlowApp::flowid;

DcqcnFlowApp::~DcqcnFlowApp()
{
    cancelAndDelete(selfMsg);
}

void DcqcnFlowApp::initialize(int stage)
{
...
void DcqcnFlowApp::setSocketOptions()
{
...
L3Address DcqcnFlowApp::chooseDestAddr()
{
...
void DcqcnFlowApp::processStart()
{
...
void DcqcnFlowApp::processStop()
{
    socket.close();
}

void DcqcnFlowApp::handleMessageWhenUp(cMessage *msg)
{
...
void DcqcnFlowApp::socketDataArrived(UdpSocket *socket, Packet *packet)
{
    // process incoming packet
    processPacket(packet);
}

void DcqcnFlowApp::socketErrorArrived(UdpSocket *socket, Indication *indication)
{
    EV_WARN << "Ignoring UDP error report " << indication->getName() << endl;
    delete indication;
}

void DcqcnFlowApp::refreshDisplay() const
{
    char buf[100];
...
void DcqcnFlowApp::processPacket(Packet *pk)
{
...
bool DcqcnFlowApp::handleNodeStart(IDoneCallback *doneCallback)
{
...
bool DcqcnFlowApp::handleNodeShutdown(IDoneCallback *doneCallback)
{
    if (selfMsg)
        cancelEvent(selfMsg);
...
void DcqcnFlowApp::handleNodeCrash()
{
    if (selfMsg)
        cancelEvent(selfMsg);
}
